        ...
        <div class="md:w-1/2 bg-white shadow p-6">
            <form method="POST" action="{{ route('perfil.store') }}" enctype="multipart/form-data" class="mt-10 md:mt-0">
                ...
                <div class="mb-5"> 
                    ...
                    <input id="password" name="password" type="password" placeholder="Tu Nuevo Password de Registro"
                ...
                <div class="mb-5"> 
                    ...
                    <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Repite tu Nuevo Password"
